...
def discover_sources(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling discover_sources with args: {call.args} and kwargs: {call.kwargs}"
        )
...
def crawl_url(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling crawl_url with args: {call.args} and kwargs: {call.kwargs}"
        )
...
def deep_crawl_site(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling deep_crawl_site with args: {call.args} and kwargs: {call.kwargs}"
        )
...
async def enhanced_deep_crawl_site_endpoint(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling enhanced_deep_crawl_site with args: {call.args} and kwargs: {call.kwargs}"
        )
...
def intelligent_source_discovery_endpoint(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling intelligent_source_discovery with args: {call.args} and kwargs: {call.kwargs}"
        )
...
def intelligent_content_crawl_endpoint(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling intelligent_content_crawl with args: {call.args} and kwargs: {call.kwargs}"
        )
...
def intelligent_batch_analysis_endpoint(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling intelligent_batch_analysis with args: {call.args} and kwargs: {call.kwargs}"
        )
...
def enhanced_newsreader_crawl_endpoint(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling enhanced_newsreader_crawl with args: {call.args} and kwargs: {call.kwargs}"
        )
...
async def production_crawl_ai_enhanced_endpoint(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling production_crawl_ai_enhanced with args: {call.args} and kwargs: {call.kwargs}"
        )
...
async def production_crawl_ultra_fast_endpoint(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling production_crawl_ultra_fast with args: {call.args} and kwargs: {call.kwargs}"
        )
...
def get_production_crawler_info_endpoint(call: ToolCall):
    try:
        ...
        logger.info(
            f"Calling get_production_crawler_info with args: {call.args} and kwargs: {call.kwargs}"
        )
